...
class SharedResources {
    ...
    // TODO #1: Add a ReentrantLock(s) here to protect critical sections
     public static final ReentrantLock lockCts = new ReentrantLock();
     public static final ReentrantLock lockCmp = new ReentrantLock();
     public static final ReentrantLock lockAwt = new ReentrantLock();
...
public class SchedulerSimulationSync {
    public static void main(String[] args) {
        ...
        int studentID = 444052883;  // ← CHANGE THIS TO YOUR ACTUAL STUDENT ID
